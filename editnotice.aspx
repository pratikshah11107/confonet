<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="editnotice.aspx.vb" Inherits="editnotice" title="Edit Notice" %>
        ...
        <tr>
            <td class="style25" colspan="5">
                ...
                <asp:Label ID="addntclbl" runat="server"   
                    Text="Edit Notice"  SkinID ="main" ></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style29">
